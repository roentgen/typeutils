...
int main()
{
	...
	printf("%zu\n", type_t< sel_t< char, int > >::trv());
	printf("%zu\n", type_t< agg_t< type_t< agg_t<int, int> >, int > >::trv());
	/* selection a select type and x  */
	printf("%zu\n", type_t< sel_t< char, sel_t< int, char > > >::trv());
	/* aggregation a selector type and x */
	printf("%zu\n", sigma_size< type_t< int > >::value);
	printf("%zu\n", sel_t< int >::trv());
	printf("%zu\n", sigma_size< sel_t_t< size_t, 1, 2, 3 > >::value);
	printf("%zu\n", type_t< agg_t< char, sel_t< int, char > , int > >::trv());

	using Simple1 = type_t< agg_t< char, char, int, double > >;
	...
	using Sel1 = type_t< sel_t< int, char, bool, double > >;
	...
	using Agg1 = type_t< agg_t< int, float, agg_t< double, float > > >;
	...
	using Sel2 = type_t< sel_t< int, float, sel_t< double, float > > >;
	...
	using SA1 = type_t< sel_t< int, float, agg_t< double, float > > >;
	...
	using AS1 = type_t< agg_t< int, float, sel_t< double, float > > >;
	...
	using T = type_t< agg_t< char, sel_t< int, char > , sel_t< agg_t< int, int >, agg_t< double, double > >, sel_t< int > > >;
	printf("%zu\n", T::trv());
